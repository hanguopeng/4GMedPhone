...
function showHis(){
  ...
  common.post({
    ...
    data:JSON.stringify({
      patientId: person.id,
      limit: -1,
      templateList:[{"templateCode":"dnzqtzs","templateVersion":1}]
    }),
    success:function(ret){
...
function openDetailWin(id){
  api.openWin({
      name: 'win_dnzqtzs_detail',
      url: './win_dnzqtzs_detail.html',
      pageParam: {
          data: id
      }
  });
